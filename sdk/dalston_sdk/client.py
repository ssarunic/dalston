            ...
            models.append(
                Model(
                    ...
                    capabilities=ModelCapabilities(
                        ...
                        native_streaming=m.get("native_streaming", False),
                        word_timestamps=m.get("word_timestamps", False),
                        punctuation=m.get("punctuation", False),
                        capitalization=m.get("capitalization", False),
                    ),
                    hardware=hardware,
                    name=m.get("name"),
