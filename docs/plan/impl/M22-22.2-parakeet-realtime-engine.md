...
stt-rt-transcribe-parakeet-1:
  ...
  environment:
    ...
    - WORKER_PORT=9000
    - WORKER_ENDPOINT=ws://stt-rt-transcribe-parakeet-1:9000
    - MAX_SESSIONS=4
...
stt-rt-transcribe-parakeet-2:
  build:
    context: .
    dockerfile: engines/realtime/parakeet-streaming/Dockerfile
  environment:
    - WORKER_ID=stt-rt-transcribe-parakeet-2
    - WORKER_PORT=9000
    - WORKER_ENDPOINT=ws://stt-rt-transcribe-parakeet-2:9000
    - MAX_SESSIONS=4
    - REDIS_URL=redis://redis:6379
  tmpfs:
    - /tmp/dalston:size=2G
...
{
  "worker_id": "stt-rt-transcribe-parakeet-1",
  "endpoint": "ws://stt-rt-transcribe-parakeet-1:9000",
  "capacity": 4,
