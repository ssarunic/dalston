...
# System retention template IDs (V2 - artifact-centric model)
# These are created by the database seed migration and should never change.
SYSTEM_TEMPLATE_DEFAULT = UUID("00000000-0000-0000-0000-000000000010")
SYSTEM_TEMPLATE_ZERO_RETENTION = UUID("00000000-0000-0000-0000-000000000011")
SYSTEM_TEMPLATE_KEEP_FOREVER = UUID("00000000-0000-0000-0000-000000000012")
SYSTEM_TEMPLATE_PII_COMPLIANT = UUID("00000000-0000-0000-0000-000000000013")
